<script lang="ts">
	...
	export let repositoryTitle: string = '#';
...
<Modal bind:this={modal} width="small">
	<div class="remove-project-description">
		<p class="text-base-body-14">
			...
			<span class="font-bold">{repositoryTitle}</span>?
		</p>

		<p class="text-base-body-12 details-text">
			When you delete your repository, your "repository" doesn't get deleted. It just removes the
			repository from the list, keeping your repository safe and easy to access.
		</p>
	</div>
